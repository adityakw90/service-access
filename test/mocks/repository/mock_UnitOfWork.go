...
func (_m *MockUnitOfWork) Do(ctx context.Context, fn func(repository.RepositoryProvider) error) error {
...
//   - ctx context.Context
//   - fn func(repository.RepositoryProvider) error
...
func (_c *MockUnitOfWork_Do_Call) Run(run func(ctx context.Context, fn func(repository.RepositoryProvider) error)) *MockUnitOfWork_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(repository.RepositoryProvider) error))
	})
	return _c
}
...
func (_c *MockUnitOfWork_Do_Call) RunAndReturn(run func(context.Context, func(repository.RepositoryProvider) error) error) *MockUnitOfWork_Do_Call {
	_c.Call.Return(run)
	return _c
}
